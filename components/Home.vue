...
<img src="/assets/img/home.webp" alt="" class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center">
...
<div class="mx-auto max-w-7xl px-6 lg:px-8">
  <div class="mx-auto max-w-2xl lg:mx-0">
    <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">LIBRAIREI UMUCO</h2>
    <p class="mt-8 text-pretty text-lg font-semibold font-medium text-gray-300 sm:text-xl/8">This year, Librairie Umuco brings you a new collection designed to enrich your mind and inspire your journey. Discover stories, knowledge, and ideas that empower you to thrive in a world full of challeng</p>
  </div>
